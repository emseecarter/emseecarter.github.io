...
# McCarter Blog build configuration file, created by
# `ablog start` on Wed Dec  2 20:16:05 2020.
#
...
blog_title = u'McCarter Blog'

# Base URL for the website, required for generating feeds.
# e.g. blog_baseurl = "http://example.com/"
blog_baseurl = u'https://emseecarter.github.io/'
...
blog_authors = {
    'Patrick C. McCarter': ('Patrick C. McCarter', None),
}
...
project = u'McCarter Blog'
copyright = u'2020, Patrick C. McCarter'
author = u'Patrick C. McCarter'
...
htmlhelp_basename = 'McCarterBlogdoc'
